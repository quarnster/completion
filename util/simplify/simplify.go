//go:generate "/home/vavrusa/go/bin/pegparser" "-peg=../util/simplify/simplify.peg" "-notest" "-ignore=NewLine,EOF,Spacing,End,Impl,Contents,Simplified" "-testfile=" "-outpath" "../util/simplify/" "-generator=go"
