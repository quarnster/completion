...
func main() {
	...
	buildPeg("../net/csharp/csharp.peg", "Primary,BOM,Spacing,Reference,Grouping,InnerScope,EndOfLine,Comment,LineComment,BlockComment,Loops,Code,SpacedIdentifier,SpacedAccess")
	tests := []string{"test"}
	if verbose {
